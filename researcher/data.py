...
def retrieve_CO2():
    ...
    open(rootPath + 'researcher/data/CO2Data.txt', 'w')
...
def retrieve_N2O():
    ...
    open(rootPath + 'researcher/data/N2OData.txt', 'w')
...
def retrieve_CH4():
    ...
    open(rootPath + 'researcher/data/CH4Data.txt', 'w')
...
def retrieve_CFC11():
    ...
    open(rootPath + 'researcher/data/CFC11Data.txt', 'w')
...
def retrieve_CFC12():
    ...
    open(rootPath + 'researcher/data/CFC12Data.txt', 'w')
...
def retrieve_Temperature():
    ...
    open(rootPath + 'researcher/data/TemperatureData.txt', 'w')
